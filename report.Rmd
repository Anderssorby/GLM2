...
where $N$ is the total number of games, $p_{i\cdot}$ is the fraction of games where the goals scored by the hometeam were of category $i$, and likewise for $p_{\cdot j}$.
...
The test gives a p-value of 0.5871, which means that there is no evidence against the assumption of independence. 
